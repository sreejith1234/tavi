...
<procedure:procedure-layout id="6e1f83e3-d25a-45f8-8ee7-370350b0d9c0"
	...
	<div class="col-xs-12" ng-controller="TaviPrePHVCtMriScanController"
        ...
        <textarea class="txtarea-new-des-demo"
			...
			<div
				...
				<div class="col-xs-12"
					style="padding: 15px 15px 15px 15px; background: #f4f6f7; border: 1px solid #CCC">
   ...
   <div class="col-xs-6 p-0" >
      <div class="col-xs-12 p-0" >
         <b>Right Subclavian Artery</b>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
        <procedure:component id="_rsarterymin">
            Min
            <ahimsa-archive expression = "${expr3}" callback = "loadArchive" ></ahimsa-archive>
                <!--  <span class="his-icon"
                        ng-click="showHistoryClicked($event,'${expr3}')"><i
                        class="fa fa-history" aria-hidden="true"></i></span> -->
                     <input type="number" id="_rsarterymin" name="rsarterymin"
                        class="in-field"
                        ng-model="$parent.sectionData[sectionIndex].${key}"
                        ng-model-options="{ updateOn: 'default' }"
                        ng-disabled="$parent.patientdata.freeze" min="0" step="0.001" />
                  ...
                  <procedure:procedure-layout
                     id="cc33217d-8ed9-439f-b81f-1d2cbf5491b1"
                     section="TAVI_PROCEDURE_COMMENTS_GROUP">
                     <procedure:component id="_rsarterymincomment">
                        <span class="com-icon"
                           ng-click="showCtmriCommentBox($event, '$parent.commentsData[sectionIndex].${key}')"><i
                           class="fa fa-commenting" aria-hidden="true"></i></span>
                     </procedure:component>
                  ...
                  <span class="err-span-v2"
                        ng-show="ctmriForm.rsarterymin.$error.min || ctmriForm.rsarterymin.$error.step || ctmriForm.rsarterymin.$error.number">Not
                        a valid number!</span>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         <procedure:component id="_rsarterymax">
            Max
            <ahimsa-archive expression = "${expr3}" callback = "loadArchive" ></ahimsa-archive>
                <!--  <span class="his-icon"
                        ng-click="showHistoryClicked($event,'${expr3}')"><i
                        class="fa fa-history" aria-hidden="true"></i></span> -->
                     <input type="number" id="_rsarterymax" name="rsarterymax"
                        class="in-field"
                        ng-model="$parent.sectionData[sectionIndex].${key}"
                        ng-model-options="{ updateOn: 'default' }"
                        ng-disabled="$parent.patientdata.freeze" min="0" step="0.001" />
                  ...
                  <procedure:procedure-layout
                     id="cc33217d-8ed9-439f-b81f-1d2cbf5491b1"
                     section="TAVI_PROCEDURE_COMMENTS_GROUP">
                     <procedure:component id="_rsarterymaxcomment">
                        <span class="com-icon"
                           ng-click="showCtmriCommentBox($event, '$parent.commentsData[sectionIndex].${key}')"><i
                           class="fa fa-commenting" aria-hidden="true"></i></span>
                     </procedure:component>
                  ...
                  <span class="err-span-v2"
                        ng-show="ctmriForm.rsarterymax.$error.min || ctmriForm.rsarterymax.$error.step || ctmriForm.rsarterymax.$error.number">Not
                        a valid number!</span>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         Average
         <input type="number" name="rcheight" class="in-field" ng-value = "findAvg($parent.sectionData[sectionIndex].rsarterymin,$parent.sectionData[sectionIndex].rsarterymax)" ng-disabled="true">
       
      </div>
   </div>
   <div class="col-xs-6 p-0" >
      <div class="col-xs-12 p-0" >
         <b>Left Subclavian Artery</b>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         <procedure:component id="_lsarterymin">
            Min
            <ahimsa-archive expression = "${expr3}" callback = "loadArchive" ></ahimsa-archive>
                <!--  <span class="his-icon"
                        ng-click="showHistoryClicked($event,'${expr3}')"><i
                        class="fa fa-history" aria-hidden="true"></i></span> -->
                     <input type="number" id="_lsarterymin" name="lsarterymin"
                        class="in-field"
                        ng-model="$parent.sectionData[sectionIndex].${key}"
                        ng-model-options="{ updateOn: 'default' }"
                        ng-disabled="$parent.patientdata.freeze" min="0" step="0.001" />
                  ...
                  <procedure:procedure-layout
                     id="cc33217d-8ed9-439f-b81f-1d2cbf5491b1"
                     section="TAVI_PROCEDURE_COMMENTS_GROUP">
                     <procedure:component id="_lsarterymincomment">
                        <span class="com-icon"
                           ng-click="showCtmriCommentBox($event, '$parent.commentsData[sectionIndex].${key}')"><i
                           class="fa fa-commenting" aria-hidden="true"></i></span>
                     </procedure:component>
                  ...
                  <span class="err-span-v2"
                        ng-show="ctmriForm.lsarterymin.$error.min || ctmriForm.lsarterymin.$error.step || ctmriForm.lsarterymin.$error.number">Not
                        a valid number!</span>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         <procedure:component id="_lsarterymax">
            Max
            <ahimsa-archive expression = "${expr3}" callback = "loadArchive" ></ahimsa-archive>
                <!--  <span class="his-icon"
                        ng-click="showHistoryClicked($event,'${expr3}')"><i
                        class="fa fa-history" aria-hidden="true"></i></span> -->
                     <input type="number" id="_lsarterymax" name="lsarterymax"
                        class="in-field"
                        ng-model="$parent.sectionData[sectionIndex].${key}"
                        ng-model-options="{ updateOn: 'default' }"
                        ng-disabled="$parent.patientdata.freeze" min="0" step="0.001" />
                  ...
                  <procedure:procedure-layout
                     id="cc33217d-8ed9-439f-b81f-1d2cbf5491b1"
                     section="TAVI_PROCEDURE_COMMENTS_GROUP">
                     <procedure:component id="_lsarterymaxcomment">
                        <span class="com-icon"
                           ng-click="showCtmriCommentBox($event, '$parent.commentsData[sectionIndex].${key}')"><i
                           class="fa fa-commenting" aria-hidden="true"></i></span>
                     </procedure:component>
                  ...
                  <span class="err-span-v2"
                        ng-show="ctmriForm.lsarterymax.$error.min || ctmriForm.lsarterymax.$error.step || ctmriForm.lsarterymax.$error.number">Not
                        a valid number!</span>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         Average
         <input type="number" name="rcheight" class="in-field" ng-value = "findAvg($parent.sectionData[sectionIndex].lsarterymin,$parent.sectionData[sectionIndex].lsarterymax)" ng-disabled="true">
      </div>
   </div>
   <div class="col-xs-6 p-0" >
      <div class="col-xs-12 p-0" >
         <b>Right Common Iliac Artery</b>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         <procedure:component id="_rciliacarterymin">
            Min
            <ahimsa-archive expression = "${expr3}" callback = "loadArchive" ></ahimsa-archive>
                <!--  <span class="his-icon"
                        ng-click="showHistoryClicked($event,'${expr3}')"><i
                        class="fa fa-history" aria-hidden="true"></i></span> -->
                     <input type="number" id="_rciliacarterymin" name="rciliacarterymin"
                        class="in-field"
                        ng-model="$parent.sectionData[sectionIndex].${key}"
                        ng-model-options="{ updateOn: 'default' }"
                        ng-disabled="$parent.patientdata.freeze" min="0" step="0.001" />
                  ...
                  <procedure:procedure-layout
                     id="cc33217d-8ed9-439f-b81f-1d2cbf5491b1"
                     section="TAVI_PROCEDURE_COMMENTS_GROUP">
                     <procedure:component id="_rclarterymincomment">
                        <span class="com-icon"
                           ng-click="showCtmriCommentBox($event, '$parent.commentsData[sectionIndex].${key}')"><i
                           class="fa fa-commenting" aria-hidden="true"></i></span>
                     </procedure:component>
                  ...
                  <span class="err-span-v2"
                        ng-show="ctmriForm.rciliacarterymin.$error.min || ctmriForm.rciliacarterymin.$error.step || ctmriForm.rciliacarterymin.$error.number">Not
                        a valid number!</span>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         <procedure:component id="_rciliacarterymax">
            Max
            <ahimsa-archive expression = "${expr3}" callback = "loadArchive" ></ahimsa-archive>
                <!--  <span class="his-icon"
                        ng-click="showHistoryClicked($event,'${expr3}')"><i
                        class="fa fa-history" aria-hidden="true"></i></span> -->
                     <input type="number" id="_rciliacarterymax" name="rciliacarterymax"
                        class="in-field"
                        ng-model="$parent.sectionData[sectionIndex].${key}"
                        ng-model-options="{ updateOn: 'default' }"
                        ng-disabled="$parent.patientdata.freeze" min="0" step="0.001" />
                  ...
                  <procedure:procedure-layout
                     id="cc33217d-8ed9-439f-b81f-1d2cbf5491b1"
                     section="TAVI_PROCEDURE_COMMENTS_GROUP">
                     <procedure:component id="_rclarterymaxcomment">
                        <span class="com-icon"
                           ng-click="showCtmriCommentBox($event, '$parent.commentsData[sectionIndex].${key}')"><i
                           class="fa fa-commenting" aria-hidden="true"></i></span>
                     </procedure:component>
                  ...
                  <span class="err-span-v2"
                        ng-show="ctmriForm.rciliacarterymax.$error.min || ctmriForm.rciliacarterymax.$error.step || ctmriForm.rciliacarterymax.$error.number">Not
                        a valid number!</span>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         Average
         <input type="number" name="rcheight" class="in-field"  ng-value = "findAvg($parent.sectionData[sectionIndex].rciliacarterymin,$parent.sectionData[sectionIndex].rciliacarterymax)" ng-disabled="true">
      </div>
   </div>
   <div class="col-xs-6 p-0" >
      <div class="col-xs-12 p-0">
         <b>Left Common Iliac Artery</b>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
        <procedure:component id="_lciliacarterymin">
            Min
            <ahimsa-archive expression = "${expr3}" callback = "loadArchive" ></ahimsa-archive>
                <!--  <span class="his-icon"
                        ng-click="showHistoryClicked($event,'${expr3}')"><i
                        class="fa fa-history" aria-hidden="true"></i></span> -->
                     <input type="number" id="_lciliacarterymin" name="lciliacarterymin"
                        class="in-field"
                        ng-model="$parent.sectionData[sectionIndex].${key}"
                        ng-model-options="{ updateOn: 'default' }"
                        ng-disabled="$parent.patientdata.freeze" min="0" step="0.001" />
                  ...
                  <procedure:procedure-layout
                     id="cc33217d-8ed9-439f-b81f-1d2cbf5491b1"
                     section="TAVI_PROCEDURE_COMMENTS_GROUP">
                     <procedure:component id="_lclarterymincomment">
                        <span class="com-icon"
                           ng-click="showCtmriCommentBox($event, '$parent.commentsData[sectionIndex].${key}')"><i
                           class="fa fa-commenting" aria-hidden="true"></i></span>
                     </procedure:component>
                  ...
                  <span class="err-span-v2"
                        ng-show="ctmriForm.lciliacarterymin.$error.min || ctmriForm.lciliacarterymin.$error.step || ctmriForm.lciliacarterymin.$error.number">Not
                        a valid number!</span>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         <procedure:component id="_lciliacarterymax">
            Max
            <ahimsa-archive expression = "${expr3}" callback = "loadArchive" ></ahimsa-archive>
                <!--  <span class="his-icon"
                        ng-click="showHistoryClicked($event,'${expr3}')"><i
                        class="fa fa-history" aria-hidden="true"></i></span> -->
                     <input type="number" id="_lciliacarterymax" name="lciliacarterymax"
                        class="in-field"
                        ng-model="$parent.sectionData[sectionIndex].${key}"
                        ng-model-options="{ updateOn: 'default' }"
                        ng-disabled="$parent.patientdata.freeze" min="0" step="0.001" />
                  ...
                  <procedure:procedure-layout
                     id="cc33217d-8ed9-439f-b81f-1d2cbf5491b1"
                     section="TAVI_PROCEDURE_COMMENTS_GROUP">
                     <procedure:component id="_lclarterymaxcomment">
                        <span class="com-icon"
                           ng-click="showCtmriCommentBox($event, '$parent.commentsData[sectionIndex].${key}')"><i
                           class="fa fa-commenting" aria-hidden="true"></i></span>
                     </procedure:component>
                  ...
                  <span class="err-span-v2"
                        ng-show="ctmriForm.lciliacarterymax.$error.min || ctmriForm.lciliacarterymax.$error.step || ctmriForm.lciliacarterymax.$error.number">Not
                        a valid number!</span>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         Average
         <input type="number" name="rcheight" class="in-field" ng-value = "findAvg($parent.sectionData[sectionIndex].lciliacarterymin,$parent.sectionData[sectionIndex].lciliacarterymax)" ng-disabled="true">
      </div>
   </div>
   <div class="col-xs-6 p-0" >
      <div class="col-xs-12 p-0">
         <b>Right External Iliac Artery</b>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         <procedure:component id="_reiliacarterymin">
            Min
            <ahimsa-archive expression = "${expr3}" callback = "loadArchive" ></ahimsa-archive>
                <!--  <span class="his-icon"
                        ng-click="showHistoryClicked($event,'${expr3}')"><i
                        class="fa fa-history" aria-hidden="true"></i></span> -->
                     <input type="number" id="_reiliacarterymin" name="reiliacarterymin"
                        class="in-field"
                        ng-model="$parent.sectionData[sectionIndex].${key}"
                        ng-model-options="{ updateOn: 'default' }"
                        ng-disabled="$parent.patientdata.freeze" min="0" step="0.001" />
                  ...
                  <procedure:procedure-layout
                     id="cc33217d-8ed9-439f-b81f-1d2cbf5491b1"
                     section="TAVI_PROCEDURE_COMMENTS_GROUP">
                     <procedure:component id="_relarterymincomment">
                        <span class="com-icon"
                           ng-click="showCtmriCommentBox($event, '$parent.commentsData[sectionIndex].${key}')"><i
                           class="fa fa-commenting" aria-hidden="true"></i></span>
                     </procedure:component>
                  ...
                  <span class="err-span-v2"
                        ng-show="ctmriForm.reiliacarterymin.$error.min || ctmriForm.reiliacarterymin.$error.step || ctmriForm.reiliacarterymin.$error.number">Not
                        a valid number!</span>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
          <procedure:component id="_reiliacarterymax">
            Max
            <ahimsa-archive expression = "${expr3}" callback = "loadArchive" ></ahimsa-archive>
                <!--  <span class="his-icon"
                        ng-click="showHistoryClicked($event,'${expr3}')"><i
                        class="fa fa-history" aria-hidden="true"></i></span> -->
                     <input type="number" id="_reiliacarterymax" name="reiliacarterymax"
                        class="in-field"
                        ng-model="$parent.sectionData[sectionIndex].${key}"
                        ng-model-options="{ updateOn: 'default' }"
                        ng-disabled="$parent.patientdata.freeze" min="0" step="0.001" />
                  ...
                  <procedure:procedure-layout
                     id="cc33217d-8ed9-439f-b81f-1d2cbf5491b1"
                     section="TAVI_PROCEDURE_COMMENTS_GROUP">
                     <procedure:component id="_relarterymaxcomment">
                        <span class="com-icon"
                           ng-click="showCtmriCommentBox($event, '$parent.commentsData[sectionIndex].${key}')"><i
                           class="fa fa-commenting" aria-hidden="true"></i></span>
                     </procedure:component>
                  ...
                  <span class="err-span-v2"
                        ng-show="ctmriForm.reiliacarterymax.$error.min || ctmriForm.reiliacarterymax.$error.step || ctmriForm.reiliacarterymax.$error.number">Not
                        a valid number!</span>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         Average
         <input type="number" name="rcheight" class="in-field" ng-value = "findAvg($parent.sectionData[sectionIndex].reiliacarterymin,$parent.sectionData[sectionIndex].reiliacarterymax)" ng-disabled="true">
      </div>
   </div>
   <div class="col-xs-6 p-0" >
      <div class="col-xs-12 p-0">
         <b>Left External Iliac Artery</b>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
          <procedure:component id="_leiliacarterymin">
            Min
            <ahimsa-archive expression = "${expr3}" callback = "loadArchive" ></ahimsa-archive>
                <!--  <span class="his-icon"
                        ng-click="showHistoryClicked($event,'${expr3}')"><i
                        class="fa fa-history" aria-hidden="true"></i></span> -->
                     <input type="number" id="_leiliacarterymin" name="leiliacarterymin"
                        class="in-field"
                        ng-model="$parent.sectionData[sectionIndex].${key}"
                        ng-model-options="{ updateOn: 'default' }"
                        ng-disabled="$parent.patientdata.freeze" min="0" step="0.001" />
                  ...
                  <procedure:procedure-layout
                     id="cc33217d-8ed9-439f-b81f-1d2cbf5491b1"
                     section="TAVI_PROCEDURE_COMMENTS_GROUP">
                     <procedure:component id="_lelarterymincomment">
                        <span class="com-icon"
                           ng-click="showCtmriCommentBox($event, '$parent.commentsData[sectionIndex].${key}')"><i
                           class="fa fa-commenting" aria-hidden="true"></i></span>
                     </procedure:component>
                  ...
                  <span class="err-span-v2"
                        ng-show="ctmriForm.leiliacarterymin.$error.min || ctmriForm.leiliacarterymin.$error.step || ctmriForm.leiliacarterymin.$error.number">Not
                        a valid number!</span>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
          <procedure:component id="_leiliacarterymax">
            Max
            <ahimsa-archive expression = "${expr3}" callback = "loadArchive" ></ahimsa-archive>
                <!--  <span class="his-icon"
                        ng-click="showHistoryClicked($event,'${expr3}')"><i
                        class="fa fa-history" aria-hidden="true"></i></span> -->
                     <input type="number" id="_leiliacarterymax" name="leiliacarterymax"
                        class="in-field"
                        ng-model="$parent.sectionData[sectionIndex].${key}"
                        ng-model-options="{ updateOn: 'default' }"
                        ng-disabled="$parent.patientdata.freeze" min="0" step="0.001" />
                  ...
                  <procedure:procedure-layout
                     id="cc33217d-8ed9-439f-b81f-1d2cbf5491b1"
                     section="TAVI_PROCEDURE_COMMENTS_GROUP">
                     <procedure:component id="_lelarterymaxcomment">
                        <span class="com-icon"
                           ng-click="showCtmriCommentBox($event, '$parent.commentsData[sectionIndex].${key}')"><i
                           class="fa fa-commenting" aria-hidden="true"></i></span>
                     </procedure:component>
                  ...
                  <span class="err-span-v2"
                        ng-show="ctmriForm.leiliacarterymax.$error.min || ctmriForm.leiliacarterymax.$error.step || ctmriForm.leiliacarterymax.$error.number">Not
                        a valid number!</span>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         Average
         <input type="number" name="rcheight" class="in-field"  ng-value = "findAvg($parent.sectionData[sectionIndex].leiliacarterymin,$parent.sectionData[sectionIndex].leiliacarterymax)" ng-disabled="true">
      </div>
   </div>
   <div class="col-xs-6 p-0" >
      <div class="col-xs-12 p-0">
         <b>Right Common Femoral Artery</b>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         <procedure:component id="_rcfemoralarterymin">
            Min
            <ahimsa-archive expression = "${expr3}" callback = "loadArchive" ></ahimsa-archive>
                <!--  <span class="his-icon"
                        ng-click="showHistoryClicked($event,'${expr3}')"><i
                        class="fa fa-history" aria-hidden="true"></i></span> -->
                     <input type="number" id="_rcfemoralarterymin" name="rcfemoralarterymin"
                        class="in-field"
                        ng-model="$parent.sectionData[sectionIndex].${key}"
                        ng-model-options="{ updateOn: 'default' }"
                        ng-disabled="$parent.patientdata.freeze" min="0" step="0.001" />
                  ...
                  <procedure:procedure-layout
                     id="cc33217d-8ed9-439f-b81f-1d2cbf5491b1"
                     section="TAVI_PROCEDURE_COMMENTS_GROUP">
                     <procedure:component id="_rcfarterymincomment">
                        <span class="com-icon"
                           ng-click="showCtmriCommentBox($event, '$parent.commentsData[sectionIndex].${key}')"><i
                           class="fa fa-commenting" aria-hidden="true"></i></span>
                     </procedure:component>
                  ...
                  <span class="err-span-v2"
                        ng-show="ctmriForm.rcfemoralarterymin.$error.min || ctmriForm.rcfemoralarterymin.$error.step || ctmriForm.rcfemoralarterymin.$error.number">Not
                        a valid number!</span>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
          <procedure:component id="_rcfemoralarterymax">
            Max
            <ahimsa-archive expression = "${expr3}" callback = "loadArchive" ></ahimsa-archive>
                <!--  <span class="his-icon"
                        ng-click="showHistoryClicked($event,'${expr3}')"><i
                        class="fa fa-history" aria-hidden="true"></i></span> -->
                     <input type="number" id="_rcfemoralarterymax" name="rcfemoralarterymax"
                        class="in-field"
                        ng-model="$parent.sectionData[sectionIndex].${key}"
                        ng-model-options="{ updateOn: 'default' }"
                        ng-disabled="$parent.patientdata.freeze" min="0" step="0.001" />
                  ...
                  <procedure:procedure-layout
                     id="cc33217d-8ed9-439f-b81f-1d2cbf5491b1"
                     section="TAVI_PROCEDURE_COMMENTS_GROUP">
                     <procedure:component id="_rcfarterymaxcomment">
                        <span class="com-icon"
                           ng-click="showCtmriCommentBox($event, '$parent.commentsData[sectionIndex].${key}')"><i
                           class="fa fa-commenting" aria-hidden="true"></i></span>
                     </procedure:component>
                  ...
                  <span class="err-span-v2"
                        ng-show="ctmriForm.rcfemoralarterymax.$error.min || ctmriForm.rcfemoralarterymax.$error.step || ctmriForm.rcfemoralarterymax.$error.number">Not
                        a valid number!</span>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         Average
         <input type="number" name="rcheight" class="in-field" ng-value = "findAvg($parent.sectionData[sectionIndex].rcfemoralarterymin,$parent.sectionData[sectionIndex].rcfemoralarterymax)" ng-disabled="true">
      </div>
   </div>
   <div class="col-xs-6 p-0" >
      <div class="col-xs-12 p-0">
         <b>Left Common Femoral Artery</b>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         <procedure:component id="_lcfemoralarterymin">
            Min
            <ahimsa-archive expression = "${expr3}" callback = "loadArchive" ></ahimsa-archive>
                <!--  <span class="his-icon"
                        ng-click="showHistoryClicked($event,'${expr3}')"><i
                        class="fa fa-history" aria-hidden="true"></i></span> -->
                     <input type="number" id="_lcfemoralarterymin" name="lcfemoralarterymin"
                        class="in-field"
                        ng-model="$parent.sectionData[sectionIndex].${key}"
                        ng-model-options="{ updateOn: 'default' }"
                        ng-disabled="$parent.patientdata.freeze" min="0" step="0.001" />
                  ...
                  <procedure:procedure-layout
                     id="cc33217d-8ed9-439f-b81f-1d2cbf5491b1"
                     section="TAVI_PROCEDURE_COMMENTS_GROUP">
                     <procedure:component id="_lcfarterymincomment">
                        <span class="com-icon"
                           ng-click="showCtmriCommentBox($event, '$parent.commentsData[sectionIndex].${key}')"><i
                           class="fa fa-commenting" aria-hidden="true"></i></span>
                     </procedure:component>
                  ...
                  <span class="err-span-v2"
                        ng-show="ctmriForm.lcfemoralarterymin.$error.min || ctmriForm.lcfemoralarterymin.$error.step || ctmriForm.lcfemoralarterymin.$error.number">Not
                        a valid number!</span>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         <procedure:component id="_lcfemoralarterymax">
            Max
            <ahimsa-archive expression = "${expr3}" callback = "loadArchive" ></ahimsa-archive>
                <!--  <span class="his-icon"
                        ng-click="showHistoryClicked($event,'${expr3}')"><i
                        class="fa fa-history" aria-hidden="true"></i></span> -->
                     <input type="number" id="_lcfemoralarterymax" name="lcfemoralarterymax"
                        class="in-field"
                        ng-model="$parent.sectionData[sectionIndex].${key}"
                        ng-model-options="{ updateOn: 'default' }"
                        ng-disabled="$parent.patientdata.freeze" min="0" step="0.001" />
                  ...
                  <procedure:procedure-layout
                     id="cc33217d-8ed9-439f-b81f-1d2cbf5491b1"
                     section="TAVI_PROCEDURE_COMMENTS_GROUP">
                     <procedure:component id="_lcfarterymaxcomment">
                        <span class="com-icon"
                           ng-click="showCtmriCommentBox($event, '$parent.commentsData[sectionIndex].${key}')"><i
                           class="fa fa-commenting" aria-hidden="true"></i></span>
                     </procedure:component>
                  ...
                  <span class="err-span-v2"
                        ng-show="ctmriForm.lcfemoralarterymax.$error.min || ctmriForm.lcfemoralarterymax.$error.step || ctmriForm.lcfemoralarterymax.$error.number">Not
                        a valid number!</span>
      </div>
      <div class="col-xs-12 col-sm-4 pad5 mi-hgt-err">
         Average
         <input type="number" name="rcheight" class="in-field" ng-value = "findAvg($parent.sectionData[sectionIndex].lcfemoralarterymin,$parent.sectionData[sectionIndex].lcfemoralarterymax)" ng-disabled="true">
      </div>
   </div>
</div>
