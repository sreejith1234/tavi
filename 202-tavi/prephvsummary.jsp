...
.sub-label1{width:50% !important;border-right:solid 1px #c0c0c0;}
.sub-label2{width:50% !important;padding-left: 10px;}

.sub-label1-1{width:50% !important;border-right:solid 1px #c0c0c0;}
.sub-label2-2{width:50% !important;padding-left: 10px;border-right:solid 1px #c0c0c0;}
.sub-label2-3{width:50% !important;padding-left: 10px;}
...
<table id="mydiv">
  ...
  <tr>
    ...
    <td class="pdf-field">
      <div class="sub-label-border">
        <div class="sub-label1">I : ${euroscore1}</div>
        <div class="sub-label2">II : ${euroscore2}</div>
      </div>
    ...
    <td class="pdf-field">
      <div class="sub-label-border">
        <div class="sub-label1">Mortality : ${itrom}</div>
        <div class="sub-label2">M + M : ${itmom}</div>
      </div>
      <!-- <div class="sub-field-border">
  ...
  <tr>
    ...
    <td class="pdf-label">P=P Grad</td>
  ...
  <tr>
    ...
    <td class="pdf-field">
      <div class="sub-label-border">
        <div class="sub-label1">${_permin_permin_CTMRI}</div>
        <div class="sub-label2">${ct_annulus_width}</div>
      </div>
    ...
    <td class="pdf-field">
      <div class="sub-label-border">
        <div class="sub-label1-1">
          ${_lvotcalcium_lvotcalcium_CTMRI}
        </div>
        <div class="sub-label2-2">
          ${_lvotdia_lvotdia_CTMRI}
        </div>
        <div class="sub-label2-3">
          ${_lvotcmnt_lvotcmnt_CTMRI}
        </div>
      </div>
    </td>
  </tr>
    ...
    <tr style="background:#c4bd97">
        ...
        <td colspan="2">
          <span class="input-label">
            Others : <span class="input-label"> ${_other_other_PPLAN}</span>
          </span>
      </td>
    </tr>
